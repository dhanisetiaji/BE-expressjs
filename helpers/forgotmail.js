...
const forgotEmail = (email, code) => new Promise((resolve, reject) => {
    const url = `${process.env.URL_FORGOT}?code=${code}&email=${email}`
    axios({
        method: 'POST',
                                                                                            ...
                                                                                            <tr>
                                                                                                <td class="r8-c" align="center">
                                                                                                    <table cellspacing="0"
                                                                                                        cellpadding="0" border="0"
                                                                                                        role="presentation"
                                                                                                        width="130" class="r9-o"
                                                                                                        style="table-layout: fixed; width: 130px;">
                                                                                                        <tr
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td class="r10-i"
                                                                                                                ...
                                                                                                                <img src="https://img.mailinblue.com/4882791/images/content_library/original/62c816d198389d45706aa4cf.png"
                                                                                                                    width="130"
                                                                                                                    border="0"
                                                                                                                    class=""
                                                                                                            ...
                                                                                                            <td align="left"
                                                                                                                ...
                                                                                                                <div>
                                                                                                                    <h2 class="default-heading2"
                                                                                                                        style="margin: 0; color: #1F2D3D; font-family: arial,helvetica,sans-serif; font-size: 32px;">
                                                                                                            ...
                                                                                                            <td align="left"
                                                                                                                ...
                                                                                                                <div>
                                                                                                                    <p
                                                                                                                        ...
                                                                                                                        Just click on the button below to choose a new one. It's that easy!.</p>
                                                                                                                </div>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                        <tr
                                                                                                    ...
                                                                                                    <table cellspacing="0"
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td height="18"
                                                                                                                ...
                                                                                                                <!--[if mso]> <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="v-text-anchor:middle; height: 41px; width: 289px;" arcsize="10%" fillcolor="#5f2eea" strokecolor="#5f2eea" strokeweight="1px" data-btn="1"> <w:anchorlock/> <div style="display:none;"> <center class="default-button"><p>Verify Account</p></center> </div> </v:roundrect> <![endif]-->
                                                                                                                <!--[if !mso]><!-- -->
                                                                                                                <a class="r18-r default-button"
                                                                                                                    href='${url}'
                                                                                                                    target="_blank"
                                                                                                                    data-btn="1"
                                                                                                                    style="font-style: normal; font-weight: normal; line-height: 1.15; text-decoration: none; border-style: solid; display: inline-block; -webkit-text-size-adjust: none; mso-hide: all; background-color: #5f2eea; border-color: #5f2eea; border-radius: 4px; border-width: 0px; color: #ffffff; font-family: arial,helvetica,sans-serif; font-size: 16px; height: 18px; padding-bottom: 12px; padding-left: 5px; padding-right: 5px; padding-top: 12px; width: 280px;">
                                                                                                                    <p
                                                                                                                        style="margin: 0;">
                                                                                                                        Reset Password</p>
                                                                                                                </a>
                                                                                                                                                ...
                                                                                                                                                <th width="40"
                                                                                                                                                    ...
                                                                                                                                                    <table
                                                                                                                                                        ...
                                                                                                                                                        <tr>
                                                                                                                                                            <td class="r24-i"
                                                                                                                                                                style="font-size: 0px; line-height: 0px;">
                                                                                                                                                                <a href="https://github.com/dhanisetiaji"
                                                                                                                                                                    target="_blank"
                                                                                                                                                                    style="color: #0092ff; text-decoration: underline;">
                                                                                                                                                                    <img src="https://sendinblue-templates.s3.eu-west-3.amazonaws.com/icons/rounded_colored/github_32px.png"
                                                                                                                                                                        width="32"
                                                                                                                                                                        border="0"
                                                                                                                                                                        class=""
                                                                                                                                                ...
                                                                                                                                                <th width="40"
                                                                                                                                                    ...
                                                                                                                                                    <table
                                                                                                                                                        ...
                                                                                                                                                        <tr>
                                                                                                                                                            <td class="r24-i"
                                                                                                                                                                style="font-size: 0px; line-height: 0px;">
                                                                                                                                                                <a href="https://instagram.com/dhanisetiajiii"
                                                                                                                                                                    target="_blank"
                                                                                                                                                                    style="color: #0092ff; text-decoration: underline;">
                                                                                                                                                                    <img src="https://sendinblue-templates.s3.eu-west-3.amazonaws.com/icons/rounded_colored/instagram_32px.png"
                                                                                                                                                                        width="32"
                                                                                                                                                                        border="0"
                                                                                                                                                                        class=""
                                                                                                                                                                        style="display: block; width: 100%;"></a>
                                            ...
                                            <tr>
                                                <td class="r2-c" align="center">
                                                    <table cellspacing="0" cellpadding="0" border="0" role="presentation"
                                                        ...
                                                        <tr class="nl2go-responsive-hide">
                                                            <td height="20"
                                                                style="font-size: 20px; line-height: 20px; background-color: #eff2f7;">
                                                                ­</td>
                                                        </tr>
                                                        <tr>
